...
\hypersetup{unicode=true,
            pdftitle={P8130\_Homework\_3},
            pdfauthor={Chunxiao Zhai},
            pdfborder={0 0 0},
            breaklinks=true}
...
\item
  ...
  \bar\{X\} = \frac{1}{n}\sum\emph{\{i=1\}\^{}\{n\}X}\{\text{i}\}= EX,
\end{enumerate}

\textbackslash{}begin\{aligned\} E(S\^{}2) \&= E(\frac{1}{n-1}
\sum\emph{\{i=1\}\textsuperscript{\{n\}(X\_i-\bar\{X\})}2)\textbackslash{}
\&=\frac{n}{n-1}
E(\frac{1}{n}\sum}\{i=1\}\textsuperscript{\{n\}(X\_i-\bar\{X\})}2))\textbackslash{}
\&=\frac{n}{n-1}
E{[}E(X\_i\}\textsuperscript{2-2\bar\{X\}X\_i+\bar\{X\}}2){]}\textbackslash{}
\&=\frac{n}{n-1}
E(E(X\textsuperscript{2)-2\bar\{X\}EX+\barX}2)\textbackslash{}
\&=\frac{n}{n-1} (EX\textsuperscript{2-\barX}2)\textbackslash{}
...
\] t = \frac{\bar{d}-0}{S_d/\sqrt{n}} \sim t\_\{(n-1)\} \$\$ If
...
\includegraphics{p8103_hw_3_files/figure-latex/pressure-1.pdf}
